...
export const translations = {
  en: {
    ...
    footerText: 'SafePoint does not store personal information. If you are in immediate danger, call',
    ...
    insuranceLabel: 'Insurance type (for finding nearby resources)',
    insuranceUnknown: 'Unknown / Not sure',
    insuranceMedicaid: 'Medicaid',
    insuranceMedicare: 'Medicare',
    insurancePrivate: 'Private insurance',
  ...
  es: {
    ...
    footerText: 'SafePoint no almacena información personal. Si está en peligro inmediato, llame al',
    ...
    insuranceLabel: 'Tipo de seguro médico (para encontrar recursos cercanos)',
    insuranceUnknown: 'Desconocido / No estoy seguro',
    insuranceMedicaid: 'Medicaid',
    insuranceMedicare: 'Medicare',
    insurancePrivate: 'Seguro privado',
    insuranceNone: 'Sin seguro',
